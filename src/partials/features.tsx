...
function Features() {
    return (<div id="features"
        className=" min-h-fit flex flex-col items-center justify-center px-4">
        <div className="w-screen md:w-2/3 flex flex-col items-center justify-center gap-6 p-20 rounded-lg">
            <h1 className="text-4xl lg:text-6xl text-gray-800 font-extrabold">Features</h1>
            <p className="text-base lg:text-xl text-gray-800 text-center lg:w-4/5">
